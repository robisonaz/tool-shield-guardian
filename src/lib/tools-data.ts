import { nvdLookup, fetchTools, createTool, updateToolApi, deleteTool, fetchSubVersions, createSubVersion, updateSubVersionApi, deleteSubVersion, changeToolCategory, createZnunyTicket } from "@/lib/api-client";
